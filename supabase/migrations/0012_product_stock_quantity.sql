-- ============================================================
-- Adds inventory tracking: products.stock_quantity, enforced and
-- auto-decremented by create_sale. A sale is rejected outright if
-- any line would take a product below zero on hand — nothing is
-- written for a rejected sale, same all-or-nothing guarantee the
-- function already gave for pricing.
-- ============================================================

alter table counter.products
